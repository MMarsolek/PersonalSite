<footer class="py-20 sm:py-32 bg-black border-t border-solid border-violet-950 flex flex-col gap-4 sm:gap-8 justify-center items-center">
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        <p>
            <b class="pr-2">Email</b>MaMarsolek@gmail.com</p>
        <p>
            <b class="pr-2">Linkedin</b> 
            <a class="text-violet-400" target="_blank" href="https://www.linkedin.com/in/mariahmarsolek/">
                Mariah Marsolek<sup >
        ...
        <p>
            ...
            <a class="text-violet-400" target="_blank" href="https://github.com/MMarsolek">
            MMarsolek<sup >
                <span class="text-xs scale-75 pl-0.5">
                    <i class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"/>
                </span> </sup></a>
