...
<header class="{'sticky z-[10] top-0 duration-200 px-6 flex items-center justify-between border border-solid ' + ( y> 0 ? 'py-4 bg-slate-950 border-violet-950': 'py-6 bg-transparent border-transparent')}">
    <h1 class='font-meduim'>
        <b class="font-bold poppins">
            Mariah 
        </b>
        Marsolek
    </h1>
    ...
    <a href="https://www.linkedin.com/in/mariahmarsolek" target="_blank" class="blueShadow relative overflow-hidden px-5 py-2 froup rounded-full bg-white text-slate-950">
